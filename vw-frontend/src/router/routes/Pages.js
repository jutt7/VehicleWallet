...
const PagesRoutes = [
  {
    path: "/vrp/client/login",
    component: lazy(() =>
      import("../../views/pages/authentication/LoginCustomer")
    ),
    layout: "BlankLayout",
    meta: {
      authRoute: true,
  ...
  {
    path: "/vrp/admin/login",
    component: lazy(() =>
      import("../../views/pages/authentication/LoginAdmin")
    ),
    layout: "BlankLayout",
    meta: {
      authRoute: true,
  ...
  {
    path: "/vrp/gas-station/login",
    component: lazy(() =>
      import("../../views/pages/authentication/LoginGasStation")
    ),
    layout: "BlankLayout",
    meta: {
      authRoute: true,
  ...
  {
    path: "/vrp/supervisor/login",
    component: lazy(() =>
      import("../../views/pages/authentication/LoginSupervisor")
    ),
    layout: "BlankLayout",
    meta: {
      authRoute: true,
