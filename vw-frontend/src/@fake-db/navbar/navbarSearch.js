...
export const searchArr = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        isBookmarked: false,
        title: 'Dashboard', // Customer Dashboard
        icon: 'BarChart2',
        link: '/oms'
      },
      {
    ...
    data: [
      {
        ...
        by: 'Oliver Queen',
        size: '52kb',
        file: require('@src/assets/images/icons/react.svg').default
      },
      {
    ...
    data: [
      {
        ...
        img: require('@src/assets/images/portrait/small/avatar-blank.png').default,
        date: '01/03/2020'
      },
      {
