...
const data = {
  ...
  blogList: [
    {
      img: require("@src/assets/images/slider/2.jpg").default,
  ...
  blogSidebar: {
    recentPosts: [
      {
        img: require("@src/assets/images/banner/banner.png").default,
  ...
  blogEdit: {
    ...
    featuredImage: require("@src/assets/images/slider/2.jpg").default,
  },
};
