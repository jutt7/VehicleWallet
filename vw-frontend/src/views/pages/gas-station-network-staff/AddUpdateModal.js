...
export default function AddUpdateModal(props) {
  ...
  const submit = () => {
    ...
    if (form.civil_record_or_resident_permit_number.length < 9) {
      error.civil_record_or_resident_permit_number =
        "Residence ID should be of lenght 9";
      errorCount++;
      setoverlay(false);
    }
    ...
    // }
    if (
      helper.isEmptyString(form.designation) ||
      form.designation == "Select Designation"
    ) {
      error.designation = "Please seelct a designation";
      errorCount++;
      setoverlay(false);
    }
  ...
  const setUpdateFormValues = () => {
    console.log("dataaaaaaaaaa", props);
    ...
    setform({
      ...
      gas_station:
        ...
        helper.isObject(props.updateModalData.gas_station)
          ? {
              label: props.updateModalData.gas_station.name_en,
              value: props.updateModalData.gas_station.gas_station_id,
            }
          : [],
    });
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title className="text-center">
            {props.updateModalData
              ? t("Update Gas Station Staff")
              : t("Add Gas Station Staff")}
            {props.gasStationName ? ` - ${props.gasStationName}` : ""}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body style={{ height: "340px", overflowY: "auto" }}>
          <div>
            <ClipLoader
              css={`
                position: fixed;
              ...
              <Row>
                <Col>
                  ...
                  <input
                    ...
                    id="staff_password"
                    type="password"
                    name="gas_station_staff_password"
                    value={form.password || ""}
              ...
              <Row>
                <Col>
                  ...
                  <Select
                    ...
                    onChange={(e) => {
                      if (e) {
                        onInputchange(e, "gas_station");
                      } else {
                        onInputchange("", "gas_station");
                      }
                    }}
