...
function Client_topup_list(props) {
  ...
  const getData = () => {
    setoverlay(true);
    axios
      .post(`${jwtDefaultConfig.adminBaseUrl}/client-topup-transaction`, {
                ...
                .map((item, index) => (
                  ...
                  >
                    ...
                    <td>
                      <label
                        style={{
                          color: item.transaction_status == 2 ? "red" : "",
                        }}
                      >
                        {getStatus(item.transaction_status)}
                      </label>
                    </td>
                    {/* <td>
...
export default Client_topup_list;
