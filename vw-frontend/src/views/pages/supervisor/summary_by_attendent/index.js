...
export default function client(props) {
  ...
  const getData = () => {
    ...
    axios
      .post(
        `${jwtDefaultConfig.adminBaseUrl}/attendent-summary?page=${currentPage}&pagination=true`,
        {
          interval: {
      ...
      .then((res) => {
        ...
        if (res.status && res.status === 200) {
          ...
          setStats({
            ...
            number_of_transactions: res.data.number_of_transactions,
            total_sale_with_vw: res.data.total_sale_with_vw,
          });
  ...
  const getAttendData = () => {
    console.log("in get attend data");
    setoverlay(true);
    axios
      .get(`${jwtDefaultConfig.adminBaseUrl}/all_attendents`)
      .then((res) => {
        ...
        if (res.status && res.status === 200) {
          ...
          res.data.data.forEach((item) => {
            let obj = {
              label: item.civil_record_or_resident_permit_number,
              value: item.staff_id,
            };
            arr.push(obj);
          });
      ...
      <Row>
        ...
        <Col>
          <TotalFuel
            ...
            Count={stats.fuel_in_liters.toFixed(2)}
          />
        </Col>
        <Col>
          <TotalSales
            kFormatter={kFormatter}
            Count={stats.total_sale_with_vw}
          />
        </Col>
        <Col>
          <TotalTransactions
            ...
            {/* <Col sm={3}>
              <div className="form-group" style={{ display: "flex" }}>
                ...
                >
                  ...
                  <option value="1">Between 24 hours</option>
